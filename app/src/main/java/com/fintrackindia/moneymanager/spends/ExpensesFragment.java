...
import com.fintrackindia.moneymanager.MainFragment;
...
import com.fintrackindia.moneymanager.custom.SparseBooleanArrayParcelable;
import com.fintrackindia.moneymanager.interfaces.IConstants;
...
public class ExpensesFragment extends MainFragment implements BaseViewHolder.RecyclerClickListener {
    ...
    public void onClick(RecyclerView.ViewHolder vh, int position) {
        /*if (!expenseContainerListener.isActionMode()) {
            ...
            expenseDetail.putExtra(ExpenseDetailActivity.EXPENSE_ID_KEY, expenseSelected.getId());
