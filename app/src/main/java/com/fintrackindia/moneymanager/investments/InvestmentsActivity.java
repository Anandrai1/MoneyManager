...
public class InvestmentsActivity extends AppCompatActivity {
    public final String TAG = "InvestmentsActivity";
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new EquityInvestmentFragment(), "Equity Investment");
        adapter.addFragment(new DebetInvestmentFragment(), "Debt investment");
